...
const loggingMD = {
        ServiceType: 'common',
        FileName: 'provision-executor/lib/eitemUtils.js', };
              ...
              if (object[key]) {
                ...
                switch (pai[PN_P.action]) {
                  ...
                  case PN_T.Obfuscate: {
                    ...
                    serviceCtx.logger.logJSON('info', { serviceType: serviceCtx.name,
                              action: 'processOneSubjectMapDataToEncryptItems-Created-OItem-4-Obfuscate',
                  ...
                  case PN_T.Deobfuscate: {
                    ...
                    if (JSONLDUtils.isType(ov, pai[PN_P.privacyActionInstance2Deobfuscate])) {
                      ...
                      serviceCtx.logger.logJSON('info', { serviceType: serviceCtx.name,
                                action: 'processOneSubjectMapDataToEncryptItems-Created-OItem-For-Deobfuscate',
                                msgId: props.msgId, subjectId: object['@id'], key: key, keyDesc: keyDesc,
                                paiAction: pai[PN_P.action], pai: pai['@id'],
                                pai2Deobfuscate: pai[PN_P.privacyActionInstance2Deobfuscate], }, loggingMD);
                    } else {
                      serviceCtx.logger.logJSON('info', { serviceType: serviceCtx.name,
                                action: 'processOneSubjectMapDataToEncryptItems-Did-Not-Create-OItem-For-Deobfuscate-PAI-did-not-match',
                                msgId: props.msgId, subjectId: object['@id'], key: key, keyDesc: keyDesc,
                                paiAction: pai[PN_P.action], pai: pai['@id'],
                                pai2Deobfuscate: pai[PN_P.privacyActionInstance2Deobfuscate],
                                valuePai: ov['@type'], }, loggingMD);
                    }
